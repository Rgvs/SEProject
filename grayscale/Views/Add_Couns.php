...
<div class="container">
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
    			<form method="post" action="../Check_add_couns.php" >
        			<h2 class="form-signin-heading">Add Counselor</h2>
	        		...
	        		<input  id="inputPassword" class="form-control" name="user_password" placeholder="Password" required> </br>
					<button class="btn btn-lg btn-primary btn-block" name="adding_couns" value="log in" type="submit">Add Counselor</button>
      			</form>
			 </div>
		</div>
