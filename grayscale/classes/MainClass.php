...
//Return admin details username and password are correct, else NULL	
...
//Return counselor details username and password are correct, else NULL
...
//Return applicant details username and password are correct, else NULL
...
//Return array of messages on success, false on error
	public function getMesg($mailidAppl)
	{
		global $db;
		$qmailidAppl=$db->quote($mailidAppl);
		$query="SELECT *
